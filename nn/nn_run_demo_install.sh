...
../vendor/drush/drush/drush si standard -y --db-url=sqlite://sites/example.com/files/.ht.sqlite --account-name=nadmin --account-mail=demo@netnode.ch --account-pass=test
